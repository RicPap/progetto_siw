...
<h2 class="form-signin-heading">Create new target task</h2>
	...
	<div><br/>
		<h:selectOneMenu value="#{taskController.targetId}"
		styleClass="form-control">
			<f:selectItems value="#{superController.activityGroup}" var="member"
			itemLabel="#{member.nickName}" itemValue="#{member.id}"/>
		</h:selectOneMenu>
	</div><br/>
	<div>
		<h:commandButton value="Submit"  action="#{taskController.createTargetTask}" 
